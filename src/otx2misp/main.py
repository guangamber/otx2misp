import argparse
import logging
from .utils import setup_logger,load_config, get_start_date
...
def main():
    ...
    try:
        ...
        logger = setup_logger(logger, config_data)
    ...
    pulses = get_pulses(logger,otx, get_start_date(config_data['otx']['last_days']))
    if len(pulses) == 0:
